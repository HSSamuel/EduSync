    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4 transition-all">
        ...
        <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700">
          <label className="text-sm font-bold text-gray-500 dark:text-gray-400 whitespace-nowrap">
            Viewing:
          </label>
          <select
        ...
        {isAdmin && (
          <div className="xl:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm h-fit">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    type="time"
                    className="w-full pl-9 pr-3 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium"
              ...
              <div className="relative">
                ...
                />
                <select
                  className="w-full pl-9 pr-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-medium cursor-pointer"
              ...
              <button
                ...
                className="w-full py-2.5 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 font-bold text-sm rounded-xl hover:bg-indigo-100 dark:hover:bg-indigo-900/40 transition-colors"
              >
                Add Block
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 bg-green-600 text-white font-bold rounded-xl shadow-lg shadow-green-500/30 hover:bg-green-700 transition-all flex items-center justify-center gap-2 hover:-translate-y-0.5"
            >
              ...
              {schedule[activeDay].map((slot, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 rounded-2xl shadow-sm border transition-all hover:shadow-md ${isBreak ? "bg-amber-50/50 border-amber-100 dark:bg-amber-900/10 dark:border-amber-900/30" : "bg-white border-gray-100 dark:bg-gray-800 dark:border-gray-700"}`}
                    >
                      ...
                      {isAdmin && (
                        <button
                          ...
                          className="mt-3 text-xs font-bold text-red-500 hover:text-red-700 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity"
                        >
